...
export CONDA_BUILD_NUMBER=7
export CONDA_BUILD_LABEL=travistest
...
# conda build openblas
# anaconda upload --force ${CONDA_BUILD_DIR}/openblas-0.2.14-${CONDA_BUILD_NUMBER}.tar.bz2

# conda build hdf5-parallel
# anaconda upload --force ${CONDA_BUILD_DIR}/hdf5-parallel-1.8.14-py27_${CONDA_BUILD_NUMBER}.tar.bz2 --label ${CONDA_BUILD_LABEL}
