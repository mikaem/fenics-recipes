...
# # Weak dependencies
# conda build hdf5
# anaconda upload --force ${CONDA_BUILD_DIR}/hdf5-1.8.14-${CONDA_BUILD_NUMBER}.tar.bz2
# conda build h5py
# anaconda upload --force ${CONDA_BUILD_DIR}/h5py-2.6.0-py27_${CONDA_BUILD_NUMBER}.tar.bz2
...
#conda build hwloc
#anaconda upload --force ${CONDA_BUILD_DIR}/hwloc-1.11.2-${CONDA_BUILD_NUMBER}.tar.bz2
#conda build petsc
