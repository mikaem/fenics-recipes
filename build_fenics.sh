...
# Other dependencies
conda build hdf5
anaconda upload --force /home/mikael/anaconda2/conda-bld/linux-64/hdf5-1.8.14-${CONDA_BUILD_NUMBER}.tar.bz2 --label ${CONDA_BUILD_LABEL}
conda build h5py
anaconda upload --force /home/mikael/anaconda2/conda-bld/linux-64/h5py-2.6.0-py27_${CONDA_BUILD_NUMBER}.tar.bz2 --label ${CONDA_BUILD_LABEL}
# conda build hwloc
...
anaconda upload --force /home/mikael/anaconda2/conda-bld/linux-64/fenics-1.7.0-vtk_${CONDA_BUILD_NUMBER}.tar.bz2 --label ${CONDA_BUILD_LABEL}
